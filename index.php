...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="'nav-item"><a class="btn btn-outline-info" href="login.php">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <!-- About section-->
        <section class="bg-dark text-info " id="about">
            <div class="container px-4">
        ...
        <!-- Services section-->
        <section class="bg-dark text-info" id="services">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
        ...
        <!-- Contact section-->
        <section class="bg-dark text-info" id="contact">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h2>Contact us</h2>
